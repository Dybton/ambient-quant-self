...
const RunCard: React.FC = () => {
  ...
  const weeklyPercentage = Number((runDistance.distance / weeklyRunGoal * 100).toFixed(1));
  const monthlyPercentage = Number((runDistance.distance / monthlyGoal * 100).toFixed(1));
